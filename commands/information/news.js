...
module.exports = class extends Command {
    constructor(...args) {
      super(...args, {
        name: 'news',
        description: `Shows Rover's latest news`,
    ...
    async run(message) {
      ...
      .setTitle(`Rover News`)
      .setDescription(`***__${language.datePublished}__ ${moment(guildDB.time).format("dddd, MMMM Do YYYY")}*** *__[\`(${moment(guildDB.time).fromNow()})\`](https://Rover.deadpool296.repl.co)__*\n\n ${guildDB.news}`)
