...
module.exports = class extends Command {
  ...
  if(!channel) return message.channel.send(closed);
      await message.author.send(new discord.MessageEmbed().setColor(message.client.color.green).setFooter('Powered by https://Rover.deadpool296.repl.co').setDescription(`${message.client.emoji.success} | You can apply to the form in **${message.guild.name}** [by clicking here](https://Rover.deadpool296.repl.co/apply/${message.guild.id})`))
