...
message.channel.send(new discord.MessageEmbed().setDescription(`${language.urlCreated}\n\n**Short Url:** [https://Rover.deadpool296.repl.courl/${kaka}](https://Rover.deadpool296.repl.courl/${kaka})\n**Full url:** ${args[0]}\n\n**Please note that by making urls you abide by our [policy](https://Rover.deadpool296.repl.courl)**`).setColor(message.client.color.blue));
