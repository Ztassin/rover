...
module.exports = class extends Command {
    ...
    const prefix = guildDB.prefix;
      ...
      const green = '<a:R2:906313693623640085> ';
      const red = '<a:no2:906350284282925086> ';
      ...
      if (!args || args.length < 1) {
       ...
       categories = this.client.utils.removeDuplicates(this.client.commands.filter(cmd => cmd.category !== 'Owner').map(cmd => cmd.category));
        ...
        embed.setTitle(`Rover's Command List`)
        embed.setImage(`https://i.imgur.com/XBKqToI.gif`)
        embed.setDescription(stripIndent`
        <a:R2:906313693623640085> The Prefix for this server is \`${prefix}\`
