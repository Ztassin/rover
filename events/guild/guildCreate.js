...
logging2.moderation.mute_role = muteRole.id
    ...
    if(textChats){
      ...
      .setColor('RANDOM')
      .setDescription(`Hey Rovers! I'm **Rover**.\n\nThank you for inviting me to your server as it means a lot to us! You can get started with [\`r?help\`](https://Rover.deadpool296.repl.co) & customise your server settings by accessing the Dashboard [\`here\`](https://Rover.deadpool296.repl.co/dashboard/${guild.id}).\n\n__**Current News**__\n\`\`\`\nWe are currently giving premium to all servers until 1000 guilds! If interested Please visit https://Rover.deadpool296.repl.co\`\`\`\n\nAgain, thank you for inviting me! (this server is now very pog)\n**- Rover**`)
      .addField(
        '\u200b', 
        '**[Invite](https://Rover.deadpool296.repl.co/invite) | ' +
        '[Support Server](https://Rover.deadpool296.repl.co/support) | ' +
   '[Dashboard](https://Rover.deadpool296.repl.co/dashboard)**'
      );
    ...
    .setDescription(`Rover was added to a new Server!`)
    .addField(`Server Name`, `\`${guild.name}\``, true)
    .addField(`Server ID`, `\`${guild.id}\``, true)
    .setFooter(`${this.client.guilds.cache.size} guilds `,  'https://i.imgur.com/d7iStJL.png.png');

welcomeClient.send({
   username: 'Rover',
        avatarURL: 'https://i.imgur.com/d7iStJL.png.png',
        embeds: [welcomeEmbed],
})
