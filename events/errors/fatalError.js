...
module.exports = class extends Event {
 ...
 message.channel.send(`${message.client.emoji.fail} Hey Rover. An error Just occured and will be reported.\n\`code: ${id}\`\n\nmake sure to report it here (important) https://discord.gg/SbYUMuVV5F`).catch(()=>{});
